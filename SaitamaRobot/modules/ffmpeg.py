...
@pbot.on(admin_cmd(pattern="ffmpegsave$"))
@pbot.on(sudo_cmd(pattern="ffmpegsave$", allow_sudo=True))
...
@pbot.on(admin_cmd(pattern="vtrim"))
@pbot.on(sudo_cmd(pattern="vtrim", allow_sudo=True))
async def ff_mpeg_trim_cmd(event):
    if event.fwd_from:
        return
    if not os.path.exists(FF_MPEG_DOWN_LOAD_MEDIA_PATH):
...
@pbot.on(admin_cmd(pattern="atrim"))
@pbot.on(sudo_cmd(pattern="atrim", allow_sudo=True))
async def ff_mpeg_trim_cmd(event):
    if event.fwd_from:
        return
    if not os.path.exists(FF_MPEG_DOWN_LOAD_MEDIA_PATH):
...
@pbot.on(admin_cmd(pattern="ffmpegclear$"))
@pbot.on(sudo_cmd(pattern="ffmpegclear$", allow_sudo=True))
async def ff_mpeg_trim_cmd(event):
    if event.fwd_from:
        return
    if not os.path.exists(FF_MPEG_DOWN_LOAD_MEDIA_PATH):
